        ...
        <section class="gradient-custom">
            <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                <div class="card-body p-4 p-md-4">
                    ...
                    <hr>
                    <h3>Editar Transporte Estudiante</h3>
                    <hr>
...
export default {
    ...
    async created() {
        try {
            ...
            await axios.get(`/api/editar-transporte-estudiante/${this.$route.params.id_persona}`, {
                headers: {
    ...
    methods: {
        async updateForm() {
            try {
                const token = localStorage.getItem('token');
                await axios.post(`/api/actualizar-transporte-estudiantes/${this.$route.params.id_persona}`, {
